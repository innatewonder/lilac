...
{
public:
  static f64 GetOctaves(f64 octaves, f64 persistence,
                        f64 scale,
                        f64 x, f64 y);
  ...
  // The result will be between the two parameters passed.
  static f64 GetScaled(f64 loBound,
                      f64 hiBound,
                      f64 x, f64 y);
  ...
  static f64 Get(f64 x, f64 y);
  static f64 Get(f64 x, f64 y, f64 z);
  static f64 Get(f64 x, f64 y, f64, f64 w);
